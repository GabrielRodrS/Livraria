    ...
    <Header>
      <main className="h-9/10 w-full flex items-center justify-center">
        <div className="w-3/10 h-9/10 flex flex-col items-center rounded-sm">
          <div className=" h-1/7 w-full flex flex-row space-x-3 items-center justify-center text-2xl font-bold bg-black rounded-t-sm  text-amber-400">
          ...
          <section className="h-5/7 w-full grid grid-cols-1 rounded-b-sm bg-white shadow-2xl overflow-y-auto">
            <div className="h-45 w-full"> Item 1</div>
            <div className="h-45 w-full"> Item 2</div>
            <div className="h-45 w-full"> Item 3</div>
            <div className="h-45 w-full"> Item 4</div>
          </section>
